...
void SimpleShapeApplication::init() {
    ...
    // The vao_ variable is a member of the SimpleShapeApplication class and is defiFned in src/Application/app.h.
    ...
    OGL_CALL(glVertexAttribPointer(3, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(GLfloat),
                                   reinterpret_cast<GLvoid *>(0)));
...
void SimpleShapeApplication::frame() {
    ...
    //OGL_CALL(glDrawArrays(GL_TRIANGLES, 6, 3));
    OGL_CALL(glBindVertexArray(0));
}